...
const skills = ['React', 'Node.js', 'TypeScript', 'Python', 'PostgreSQL', 'Docker']

const skillDescriptions: Record<string, string> = {
  React: 'Construcción de interfaces de usuario interactivas y modernas',
  'Node.js': 'Desarrollo de servidores, APIs REST y lógica backend',
  TypeScript: 'Código JavaScript tipado, más seguro y mantenible',
  Python: 'Scripts, automatización, machine learning y backend',
  PostgreSQL: 'Diseño y gestión de bases de datos relacionales',
...
function Tooltip({ children, label }: { children: React.ReactNode; label: string }) {
  return (
    <div className="relative group">
      {children}
      <div className="absolute -top-10 left-1/2 -translate-x-1/2 whitespace-nowrap bg-[#1C2E1E] text-white text-xs px-3 py-1.5 rounded-lg opacity-0 group-hover:opacity-100 transition-opacity duration-200 pointer-events-none">
        {label}
      </div>
    </div>
  )
...
export default function Hero() {
  const { displayed, done } = useTypewriter("Construyo ideas\nen código.", 38, 600)
      ...
      >
        ...
        >
          <Tooltip label="WhatsApp">
            <a
              href="https://wa.me/543718652792"
              target="_blank"
              rel="noopener noreferrer"
              className="w-12 h-12 rounded-full bg-[#1C2E1E] flex items-center justify-center hover:bg-[#2a4a2a] transition-colors duration-200 no-underline"
            >
          ...
          <Tooltip label="Instagram">
            <a
              href="https://instagram.com/Maxij._"
              target="_blank"
              rel="noopener noreferrer"
              className="w-12 h-12 rounded-full bg-[#1C2E1E] flex items-center justify-center hover:bg-[#2a4a2a] transition-colors duration-200 no-underline"
            >
          ...
          <Tooltip label="LinkedIn">
            <a
              href="https://www.linkedin.com/in/maxi-romero-055242419/"
              target="_blank"
              rel="noopener noreferrer"
              className="w-12 h-12 rounded-full bg-[#1C2E1E] flex items-center justify-center hover:bg-[#2a4a2a] transition-colors duration-200 no-underline"
            >
          ...
          <Tooltip label="GitHub">
            <a
              href="https://github.com/knmaxi888-hash"
              target="_blank"
              rel="noopener noreferrer"
              className="w-12 h-12 rounded-full bg-[#1C2E1E] flex items-center justify-center hover:bg-[#2a4a2a] transition-colors duration-200 no-underline"
            >
          ...
          <Tooltip label="Email">
            <a
              href="mailto:knmaxi888@gmail.com"
              className="w-12 h-12 rounded-full bg-[#1C2E1E] flex items-center justify-center hover:bg-[#2a4a2a] transition-colors duration-200 no-underline"
            >
